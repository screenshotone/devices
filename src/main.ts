/**
 * Copyright 2023 ScreenshotOne.com All rights reserved.
 *
...
/**
 * Viewport represents a compatible type with the Puppeteer/Playwright Viewport type.
 */
...
/**
 * Device represents a compatible type with the Puppeteer/Playwright Device type.
 */
...
for (const knownDevice of knownDevices) {
    ...
    devices[key] = { id: key, ...knownDevice };
}
